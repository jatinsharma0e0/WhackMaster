...
Custom cursor: Custom hammer cursor (hammer-cursor.png) replaces default mouse cursor throughout the game with hotspot positioned at the top-left corner (0, 0) and cursor overlay offset by (-50px, 0).
